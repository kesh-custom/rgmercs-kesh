...
return {
    ...
    ['AbilitySets']   = {
        ...
        ['SpellAbsorbBuff'] = {
            ...
            "Guard of Calrena",    -- Level 57, mitigate spell dmg absorb (id 4068)
        },
        ['SpellShieldBuff'] = {
            "Spellshield", -- Level 58, SpellShield amount (id 2559)
        },
        ['Dispel'] = {
    ...
    ['RotationOrder'] = {
        ...
        },
        {
            ...
            state = 1,
            steps = 1,
            -- Always load so clickies can be registered; AA entries gate themselves below.
            targetId = function(self) return Targeting.CheckForAutoTargetID() end,
            cond = function(self, combat_state)
    ...
    ['Rotations']     = {
        ['GroupBuff'] = { -- Added to anchor clickies to
            {
                name = "SpellAbsorbBuff",
                type = "Spell",
                load_cond = function() return Config:GetSetting('DoSpellAbsorbBuff') end,
                cond = function(self, spell, target)
            ...
            {
                name = "SpellShieldBuff",
                type = "Spell",
                load_cond = function() return Config:GetSetting('DoSpellShieldBuff') end,
                cond = function(self, spell, target)
                    return Casting.GroupBuffCheck(spell, target)
                end,
            },
        ...
        ['Weaves'] = {
            {
                name = "Lower Element",
                type = "AA",
                load_cond = function() return Casting.CanUseAA("Lower Element") end,
                cond = function(self, aaName)
    ...
    ['SpellList']     = { -- New style spell list, gemless, priority-based. Will use the first set whose conditions are met.
        {
            ...
            spells = {
                ...
                -- Long recast (15s): keep gemmed when enabled so GroupBuff doesn't wait on remem
                { name = "SpellAbsorbBuff", cond = function() return Config:GetSetting('DoSpellAbsorbBuff') end, },
                ...
                { name = "SelfRune1", },
                -- SelfHPBuff: long duration / short recast — remem in Downtime, no Loadout slot
                { name = "SpellShieldBuff", cond = function() return Config:GetSetting('DoSpellShieldBuff') end, },
            },
        },
    },
    ['DefaultConfig'] = {
        ...
        ['DoSpellAbsorbBuff']    = {
            DisplayName = "Do Spell Absorb Buff",
            Group = "Abilities",
            Header = "Buffs",
            Category = "Group",
            Index = 101,
            Tooltip = "Cast Guard/Defense/Bulwark of Calrena on group members (spell damage absorb). Consumes a Peridot.\n" ..
                "Kept memorized while enabled (15s recast).",
            RequiresLoadoutChange = true,
            Default = false,
        },
        ['DoSpellShieldBuff']    = {
            DisplayName = "Do Spellshield Buff",
            Group = "Abilities",
            Header = "Buffs",
            Category = "Group",
            Index = 102,
            Tooltip = "Cast Spellshield on group members. Consumes a Peridot.",
            RequiresLoadoutChange = true,
            Default = false,
        },
    },
