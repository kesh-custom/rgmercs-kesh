...
-- Role-based heal thresholds (EQ Might SHM), same pattern as CLR.
-- Keys: HealPct{FastHeal|Light|SingleHoT|GroupHoT}_{Tank|Melee|Caster}
-- FastHeal = old Big Heal Point band. GroupRenewal is Group HoT. Default 0 = disabled until set.
...
function _ClassConfig.MigrateSettings(settings)
    ...
    local kinds = { "FastHeal", "Light", "SingleHoT", "GroupHoT", }
