...
-- Role-based heal thresholds (EQ Might PAL), same pattern as CLR.
-- Keys: HealPct{FastHeal|Light|GroupHeal|SingleHoT}_{Tank|Melee|Caster}
-- FastHeal = old Big Heal Point band (Lay on Hands / BurstHeal / etc.). Regular = Touch/Light heals.
-- Melee = non-tank melee. Default 0 = disabled until set.
...
function _ClassConfig.MigrateSettings(settings)
    ...
    local kinds = { "FastHeal", "Light", "GroupHeal", "SingleHoT", }
